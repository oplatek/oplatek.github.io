...
Labs
----
- [Week 1](/2019/02/20/ds-lab-1/)

Basic Info
----------
- Teaching assistant: Ondřej Plátek (oplatek@ufal.mff.cuni.cz, room 424 on Wednesday)
- Time and place: **Wednesday 9:00, SU2**, summer semester 2019
...
- Get points from homework exercises and bonus tasks
    - After **each lab** exercises for **3 points** are published
        - **Dead line is 7:00 AM Tuesday before next lab!**
